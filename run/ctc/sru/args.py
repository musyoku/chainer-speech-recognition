...
parser.add_argument("--ndim-rnn", "-dr", type=int, default=128)
parser.add_argument("--ndim-conv", "-dc", type=int, default=64)
parser.add_argument("--ndim-dense", "-dd", type=int, default=320)
parser.add_argument("--num-rnn-layers", "-nrnn", type=int, default=2)
